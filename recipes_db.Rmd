...
Graularities: Yes. There is apple as term but then different cultivares have their own subterm from apple. 
...
```{r}
dbGetQuery(con_recipe_db,"SELECT recipe_name, user_name AS creator, recipe_notes, course_desc
                 FROM recipe_meta
